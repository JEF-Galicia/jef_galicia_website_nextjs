...
export default function Federation() {
  ...
  return (
    <>
      <NextSeo
        title={intl.formatMessage({ defaultMessage: 'A Federación JEF' })}
        description={intl.formatMessage({
          defaultMessage:
            'Información sobre a Federación das Xuventudes Europeas Federalistas',
        })}
      />
      <BoxComponent>
        ...
        <p className="mb-6">
          ...
          <FormattedMessage defaultMessage=". A nosa visión é a dunha Europa federal, onde as decisións se tomen en común e de forma democrática, respectando a diversidade cultural e lingüística de todos os seus pobos." />
        </p>

        <p className="mb-6">
          <FormattedMessage defaultMessage="JEF é unha organización non gobernamental que ten a súa sede en Bruxelas, Bélxica, e conta con seccións nacionais en diferentes países europeos, incluíndo España. Igualmente, cada país conta con seccións rexionais, como é o caso de JEF Galicia. En conxunto, a nosa acción consiste en organizar actividades e campañas que promovan o debate e a reflexión sobre temas de interese europeo, así como a formación de novos líderes e lideresas comprometidos coa construción dunha Europa máis unida." />
        </p>
        ...
        <p className="mb-12">
          ...
          <FormattedMessage defaultMessage=". Ademais, JEF Galicia tamén colabora con outras organizacións e institucións galegas para promover a participación cidadá e o compromiso político entre a xuventude galega." />
        </p>
