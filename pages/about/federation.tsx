    ...
    return (
        <>
            ...
            <BoxComponent>
                ...
                <p className='mb-12'>No caso de JEF Galicia, a nosa labor concretízase no fomento da participación da xuventude galega na construción dunha Europa máis unida e democrática, a través da organización de<span className="font-semibold"> actividades e campañas de sensibilización e formación</span>. Ademais, JEF Galicia tamén colabora con outras organizacións e institucións galegas para promover a participación cidadá e o compromiso político entre a xuventude galega.</p>
