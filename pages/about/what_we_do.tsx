        ...
        <>
            ...
            <BoxComponent>
                ...
                <p className="mb-6">
                    ...
                    de todo tipo, dende eventos de networking e actividades de grupo,
                    ata viaxes e visitas a institucións e eventos europeos.
                </p>
                ...
                <p className="mb-6">
                    A nosa asociación tamén leva a cabo iniciativas para promover
                    a participación dos mozos e mozas na política europea. Estas
                    iniciativas abranguen desde campañas de sensibilización, ata
                ...
                <p className="mb-6">
                    JEF Galicia organiza asimesmo congresos, conferencias e eventos de maior
                    envergadura, nos que se debaten temas de interese para a
                    cidadanía europea. Estes congresos poden ser tanto en
                    formato presencial, como en formato online.
                </p>
                <div className="h-22 flex mx-0 mt-10 mb-4 flex-col place-items-center rounded">
                ...
                <p className="mb-6">
                    A nosa asociación tamén leva a cabo proxectos de maior duración,
                    que poden abranguer desde unha semana, ata varios meses. Por exemplo,
                    <Link href="/projects/bench_for_europe">Banco por Europa</Link> é un proxecto
                    que consiste en pintar bancos coa bandeira da Unión Europea, para
                    promover a sensibilización sobre a Unión Europea.
                </p>
            </BoxComponent>
        </>
    )
