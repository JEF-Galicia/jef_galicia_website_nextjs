  ...
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl p-1">
      <button
        ...
        className="flex items-center h-full pr-2 dark:bg-primary rounded-3xl justify-center align-center p-2 w-24 transition"
      >
        {moonIcon}
      </button>
      ...
      <button
        ...
        className="flex items-center h-full pr-2 bg-primary dark:bg-transparent rounded-3xl justify-center align-center p-2 w-24 transition"
      >
        {sunIcon}
      </button>
    </div>
